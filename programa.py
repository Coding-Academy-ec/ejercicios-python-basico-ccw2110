...
if __name__ == "__main__":
    ...
    num2 = int(input("Ingrese el primer número: "))  # Se solicita al usuario que ingrese el primer número
...
if __name__ == "__main__":
    ...
    fahrenheit = float(input("Ingrese la temperatura en grados fahrenheit: "))  # Se solicita al usuario que ingrese la temperatura en grados Celsius
